...
data <- read_tsv("tsv/DFT_H3K4me3_broad_auto_data.tsv", skip=2, col_names=FALSE)
...
ggsave("actuals_plots/H3K4me3/DFT_H3K4me3_broad_Quartiles_10kb_auto.png", dpi=300,
       width = 5.84, height = 3.95)

######### X Chromosome ##########

data <- read_tsv("tsv/DFT_H3K4me3_broad_X_data.tsv", skip=2, col_names=FALSE)
...
ggsave("actuals_plots/H3K4me3/DFT_H3K4me3_broad_Quartiles_10kb_ChrX.png", dpi=300,
       width = 5.84, height = 3.95)
